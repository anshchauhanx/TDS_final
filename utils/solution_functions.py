...
def use_github(new_email: str = "23f1001012@ds.study.iitm.ac.in") -> str:
    """
...
def host_your_portfolio_on_github_pages(new_email: str = "23f1001012@ds.study.iitm.ac.in") -> str:
    """
    Updates the email in index.html and deploys to GitHub Pages.

    Args:
        new_email (str): New email to display (default: "23f1001012@ds.study.iitm.ac.in").
    ...
    #         "<!--email_off-->23f1001012@ds.study.iitm.ac.in<!--/email_off-->",
...
def create_a_github_action(new_email: str = "23f1001012@ds.study.iitm.ac.in") -> str:
    """
    Updates the email in the GitHub Actions workflow and triggers the workflow.

    Args:
        new_email (str): New email to display in the workflow (default: "23f1001012@ds.study.iitm.ac.in").
    ...
    #     updated_content = current_content.replace(
    #         "- name: 23f1001012@ds.study.iitm.ac.in",
    #         f"- name: {new_email}"
    #     )
    #
    #     # Commit changes
